...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Universe = __webpack_require__(2);

	var _Universe2 = _interopRequireDefault(_Universe);

	var _Kino = __webpack_require__(3);

	var _Kino2 = _interopRequireDefault(_Kino);
	...
	(0, _jquery2.default)(document).ready(function () {
	  (0, _jquery2.default)(document).on("click", "#addU", function () {
	    addUniverse();
	  });
	});
	...
	function addUniverse() {
	  ...
	  var nameU = (0, _jquery2.default)("#nameU").val();
	  var universe = new _Universe2.default(nameU, id);
	  /*if(!validU(nameU)) {
	      $(".errmessage").show();
	  ...
	  //pasteU(universeList);
	  pasteU(universeList);
	  var nameUText = (0, _jquery2.default)("#nameU");
	  nameUText.focus();
	  nameUText.select();
	}

	function pasteU(universeList) {
	  var templateUni = Handlebars.compile((0, _jquery2.default)('#templateUni').html());
	  (0, _jquery2.default)('.selectuni').empty().append(templateUni(universeList));
	}
	...
	(0, _jquery2.default)(document).ready(function () {
	  (0, _jquery2.default)(document).on("click", "#addH", function () {
	    addHero();
	  });
	});

	(0, _jquery2.default)(document).ready(function () {
	  (0, _jquery2.default)(document).on("click", ".changeH", function () {
	    changeHero(this.id);
	  });
	});

	(0, _jquery2.default)(document).ready(function () {
	  (0, _jquery2.default)(document).on("click", ".saveH", function () {
	...
	function addHero() {
	  var nameH = (0, _jquery2.default)("#nameH").val();
	  var genderH = (0, _jquery2.default)("#genderH").val();
	  var skillH = (0, _jquery2.default)("#skillsH").val();
	  var hero = new _Hero2.default(nameH, genderH, skillH, id);
	  Heroes.push(hero);
	  console.log(Heroes);
	  pasteH(Heroes);
	...
	function pasteH(Heroes) {
	  var templateHero = Handlebars.compile((0, _jquery2.default)('#templateHero').html());
	  (0, _jquery2.default)('.herodrop').empty().append(templateHero(Heroes));
	}
	...
	function changeHero(id) {
	  ...
	  var templateFormChH = Handlebars.compile((0, _jquery2.default)('#templateFormChH').html());
	  (0, _jquery2.default)('#' + id).empty().append(templateFormChH(Heroes[i]));
	}

	function saveChangeHero(id) {
	  var i = void 0;
	  var nameHCh = (0, _jquery2.default)("#nameHCh").val();
	  var genderHCh = (0, _jquery2.default)("#genderHCh").val();
	  var skillHCh = (0, _jquery2.default)("#skillHCh").val();
	  for (i = 0; i < Heroes.length; i++) {
	    if (Heroes[i].id == id) break;
	  }
	...
	(0, _jquery2.default)(document).ready(function () {
	  (0, _jquery2.default)(document).on("click", "#add", function () {
	    addKino();
	  });
	});

	(0, _jquery2.default)(document).ready(function () {
	  (0, _jquery2.default)(document).on("click", ".deleteItem", function () {
	    removeItem(this.id);
	  });
	});
	...
	function addKino() {
	  var un = (0, _jquery2.default)(".selectuni").val();
	  var arr1 = [];

	  (0, _jquery2.default)('.herodrop input:checkbox:checked').each(function () {
	    arr1.push((0, _jquery2.default)(this).val());
	  });
	  ...
	  console.log(petya);
	  var sasha = new _Kino2.default(heroes, petya, id);
	  console.log(sasha);
	  Items.push(sasha);
	  pasteK(Items);
	  id++;
	...
	function pasteK(Items) {
	  var templateKino = Handlebars.compile((0, _jquery2.default)('#templateKino').html());
	  (0, _jquery2.default)('.kinoinfo').empty().append(templateKino(Items));
	}
...
/***/ function(module, exports) {
	...
	var Hero = function () {
	  function Hero(name, gender, skill, id) {
...
/***/ function(module, exports) {
	...
	var Kino = function () {
	  function Kino(arr, universe, id) {
	    _classCallCheck(this, Kino);
